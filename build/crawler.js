...
var Crawler = /** @class */ (function () {
    function Crawler(url, analyzer, filePath) {
        this.url = url;
    ...
    Crawler.prototype.getFileContent = function () {
    ...
    Crawler.prototype.initSpiderProcess = function () {
        return __awaiter(this, void 0, void 0, function () {
            var rawData, fileContent, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.getRawData()];
                    case 1:
                        rawData = _a.sent();
                        return [4 /*yield*/, this.getFileContent()];
                    case 2:
                        fileContent = _a.sent();
                        result = this.analyzer.analyze(rawData, fileContent);
